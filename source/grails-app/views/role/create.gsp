<head>
	...
	<title>Create bumblebee.Role</title>
</head>
...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">bumblebee.Role List</g:link></span>
	</div>

	<div class="body">

		<h1>Create bumblebee.Role</h1>
		...
		<tbody>
			<tr class="prop">
				<td valign="top" class="name"><label for="authority">bumblebee.Role Name:</label></td>
