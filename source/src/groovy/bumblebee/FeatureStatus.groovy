...
//            def notStarted = new FeatureStatus(priority: 10, name: 'not started')
//            allStatuses.add(notStarted)
            def inProgress = new FeatureStatus(priority: 20, status: 'in progress')
            allStatuses.add(inProgress)
            def readyForDev = new FeatureStatus(priority: 30, status: 'ready for dev')
